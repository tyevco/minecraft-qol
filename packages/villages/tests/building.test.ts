...
import { boxOfRecord, contains, packRecord, sameTable, unpackRecord, type BuildingRecord } from "../scripts/core/building";

const record: BuildingRecord = { dimId: "minecraft:overworld", x: 10, y: 64, z: -3, key: "tallfolk_well", rotation: 1, sx: 5, sy: 7, sz: 5, phase: "building", done: 12, table: { x: 20, y: 64, z: 0 }, free: false, palette: "", owner: "" };
