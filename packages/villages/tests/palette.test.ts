...
/** A catalogue building's cells as the palette sees them: the job post left out, since it is never swapped (`builderBlueprint` in tools/structures/builder.ts keeps it). */
