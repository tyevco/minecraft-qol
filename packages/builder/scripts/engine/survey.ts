/**
 * Survey (settlements.md §5.4): two `builder:survey_stake` blocks mark a
 ...
 * `builder:survey_<n>`, a new identifier every time (a world caches a
...
export const STAKE = "builder:survey_stake";
/** The dynamic property on a survey item naming its key. */
export const KEY_PROPERTY = "builder:key";
const COUNTER = "bd:surveys";
