...
// The page's palette, from tools/viewer/index.html.
const INK = {
  page: 0x1b1c22,
  panel: 0x1e1f26,
  line: 0x33353f,
...
<style>
  :root { color-scheme: dark; --bg:#1b1c22; --panel:#23242c; --line:#33353f; --fg:#e6e6ea; --dim:#9a9ca8; --accent:#e27928; }
...
<main>
  ...
  <p class="sub"><a href="../">← the interactive model viewer</a></p>
${sections}
  <details>
