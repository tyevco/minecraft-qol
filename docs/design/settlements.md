...
**Where the peoples live: five settlement shapes, twenty-four buildings, and the blueprint catalogue a builder works from**
...
corral is the work building: a fenced yard with a fodder strip of wheat
along one side, hay, and a shade roof over the water troughs, so its worker
is a farmer. The water tower is the watch: a plank tank on tall legs with a
...
Twenty-four blueprints, all generated by `tools/structures/buildings.ts`. Sizes
