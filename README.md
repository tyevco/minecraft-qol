...
| *(none)* | `concepts/entities/` | Six entity concepts from `docs/design/entities.md`: models, atlases, animation sets and controllers, generated so they can be judged in the viewer. Shipped by no pack; see `concepts/README.md`. |
...
tiers, hatchling variants), bone toggles (pipe arms, mule panniers), and
