...
- [`design/npcs.md`](design/npcs.md) — a concept sheet with models: five
  peoples (stonefolk, reedfolk, tinker, tallfolk, drover) as one biped rig
  with different proportions, four job outfits each as texture variants with
...
- [`design/villages.md`](design/villages.md) — found villages of the five
