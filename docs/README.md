...
- [`design/villages.md`](design/villages.md) — found villages of the eight
  peoples (the first four, then hobbits and three kinds of elf, §3.3), generated by Bedrock's data-driven jigsaw system from the
