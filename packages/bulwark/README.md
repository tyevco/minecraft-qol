# Bulwark — the turret (Phase 2: core; Phase 3: ammo kinds, upgrades, the panel)
...
`bulwark:debug` line per turret. Targeting priority, which needs a per-turret
form, is #91. Player targeting is not possible at all
...
scripts/core/                             pure: record codec, ammo kinds and rules, upgrade tiers, panel policy, hopper rule, reconcile
