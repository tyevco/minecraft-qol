...
**Found villages of the nine peoples, generated by the game; and the trust that lets the kids invite their people home**
...
| **Drover** | `desert` | Trading post, with the bell and the hitching rail on the square | smooth sandstone on sand, cacti where the others have trees | adobe cabins, corrals, ranches, the stall, larder; paddocks and scrub among the greens; the water tower at the ends | `beard_thin`, `world_surface` |
...
- **Terminators**: a lamp post (post and lantern on the joint block) or,
  ...
  water tower) facing back up the street; and a doorstep (one block of turf) where no
...
The elves wear their hood or circlet whatever their job, and a drover its
hat on every job but the guard's (the hat bone is shown for a worker, for
peoples five to seven, and for people eight when the job is not guard). The deck the
...
- **Gifts**: each people has three liked items (stonefolk: iron, coal,
  ...
  Handing one to any person is +1, once
  per person per day.
...
thresholds, all five trades as above, the cycle slider and a wages toggle
on the settings panel, the field's post and chest, the grove and mine
pieces, the dock's worker fishing into its barrel, the drover ranch (a
fenced pasture with a pond and a rancher's post; the sheep are the kids'
to bring, since a structure carries no entities). A pen of sheep wins the
survey over everything but a vein, since sheep are put there on purpose. Where the built thing
...
of the nine peoples who walks into the kids' settlement, stays a day, and
